...
defmodule Blitzy.CLI do
    ...
    |> Enum.flat_map(fn node ->
      ...
      |> Enum.map(fn _ ->
        Task.Supervisor.async(
          {Blitzy.TaskSupervisor, node}, Blitzy.Worker, :start, [url]
        )
      end)
    end)
  ...
  defp do_help do
    ...
    Example:
    ./blitzy -n 10 http://www.bieberfever.com
    """
    System.halt(0)
  end

  defp parse_results(results) do
    {successes, _failures} = Enum.partition(results, fn (x) ->
      case x do
        {:ok, _} -> true
        _ -> false
      end
